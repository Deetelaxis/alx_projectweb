...
class CustomUser(AbstractUser):
    ...
    def image_tag(self):
        ...
        return mark_safe('<img src="https://virtualtopup.com/media/%s" width="150" height="150" />' % (self.passport_photogragh))
...
class KYC(models.Model):
    ...
    def __str__(self):
        return '<img src="https://virtualtopup.com/media/{}" height="150"/>'.format(self.passport_photogragh.url)

    def upload_passport(self):
        from django.utils.html import mark_safe
        return mark_safe('<img src="https://virtualtopup/media/%s" width="150" height="150" />' % (self.passport_photogragh))
